...
public class DeviceDescriptionActivity extends AppCompatActivity {
    ...
    private UUID heartRateServiceUUID = UUID.fromString("0000aaa0-0000-1000-8000-00805f9b34fb");
    private UUID kakkaUUID = UUID.fromString("00002901-0000-1000-8000-00805f9b34fb");
